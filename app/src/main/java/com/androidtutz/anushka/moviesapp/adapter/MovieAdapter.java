...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    public MovieAdapter(Context context, ArrayList<RelatedTopic> movies) {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        holder.movieTitle.setText(movies.get(position).getText());
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        RelatedTopic selectedMovie = movies.get(position);
                        Intent intent = new Intent(context, MovieActivity.class);
                        intent.putExtra("movie", selectedMovie);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        String movieTitle = selectedMovie.getText();
